...
export const projects: Project[] = [
      ...
      <svg viewBox="0 0 600 220" preserveAspectRatio="xMidYMid slice" className="w-full h-full">
        <defs>
          <linearGradient id="g1" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="hsl(350 80% 55%)" stopOpacity="0.3" />
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 300 180" className="w-full h-full">
        <circle cx="150" cy="90" r="70" fill="none" stroke="hsl(350 80% 55%)" strokeWidth="16" strokeDasharray="290 150" opacity="0.7" />
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 300 180" className="w-full h-full">
        ...
        <polyline points="0,150 50,120 100,90 150,100 200,70 250,55 300,60" stroke="hsl(350 80% 55%)" strokeWidth="2" fill="none" />
      </svg>
    ),
  },
  {
      ...
      <svg viewBox="0 0 300 180" className="w-full h-full">
        <defs>
          <linearGradient id="g3" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="hsl(350 80% 55%)" stopOpacity="0.2" />
            <stop offset="100%" stopColor="hsl(350 80% 55%)" stopOpacity="0" />
          </linearGradient>
        </defs>
        <polygon points="0,160 60,130 120,100 180,115 240,80 300,60 300,180 0,180" fill="url(#g3)" />
        <polyline points="0,160 60,130 120,100 180,115 240,80 300,60" stroke="hsl(350 80% 55%)" strokeWidth="2" fill="none" />
      </svg>
    ),
  },
  {
